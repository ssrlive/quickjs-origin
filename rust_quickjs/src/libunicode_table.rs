...
pub const CASE_CONV_TABLE1: [u32; 378] = [
...
pub const CASE_CONV_TABLE2: [u8; 378] = [
...
pub const CASE_CONV_EXT: [u16; 58] = [
...
pub const UNICODE_PROP_CASED1_TABLE: [u8; 193] = [
...
pub const UNICODE_PROP_CASED1_INDEX: [u8; 18] = [
...
pub const UNICODE_PROP_CASE_IGNORABLE_TABLE: [u8; 764] = [
...
pub const UNICODE_PROP_CASE_IGNORABLE_INDEX: [u8; 72] = [
...
pub const UNICODE_PROP_ID_START_TABLE: [u8; 1133] = [
...
pub const UNICODE_PROP_ID_START_INDEX: [u8; 108] = [
...
pub const UNICODE_PROP_ID_CONTINUE1_TABLE: [u8; 695] = [
...
pub const UNICODE_PROP_ID_CONTINUE1_INDEX: [u8; 66] = [
...
pub const UNICODE_CC_TABLE: [u8; 916] = [
...
pub const UNICODE_CC_INDEX: [u8; 87] = [
...
pub const UNICODE_DECOMP_TABLE1: [u32; 709] = [
...
pub const UNICODE_DECOMP_TABLE2: [u16; 709] = [
...
pub const UNICODE_DECOMP_DATA: [u8; 9451] = [
...
pub const UNICODE_COMP_TABLE: [u16; 965] = [
...
pub const UNICODE_GC_TABLE: [u8; 4070] = [
...
pub const UNICODE_SCRIPT_TABLE: [u8; 2803] = [
...
pub const UNICODE_SCRIPT_EXT_TABLE: [u8; 1253] = [
...
pub const UNICODE_PROP_HYPHEN_TABLE: [u8; 28] = [
...
pub const UNICODE_PROP_OTHER_MATH_TABLE: [u8; 200] = [
...
pub const UNICODE_PROP_OTHER_ALPHABETIC_TABLE: [u8; 443] = [
...
pub const UNICODE_PROP_OTHER_LOWERCASE_TABLE: [u8; 69] = [
...
pub const UNICODE_PROP_OTHER_UPPERCASE_TABLE: [u8; 15] = [
    0x60, 0x21, 0x5f, 0x8f, 0x43, 0x45, 0x99, 0x61,
    0xcc, 0x5f, 0x99, 0x85, 0x99, 0x85, 0x99,
];

pub const UNICODE_PROP_OTHER_GRAPHEME_EXTEND_TABLE: [u8; 112] = [
...
pub const UNICODE_PROP_OTHER_DEFAULT_IGNORABLE_CODE_POINT_TABLE: [u8; 32] = [
...
pub const UNICODE_PROP_CHANGES_WHEN_NFKC_CASEFOLDED1_TABLE: [u8; 450] = [
...
pub const UNICODE_PROP_BASIC_EMOJI1_TABLE: [u8; 143] = [
...
pub const UNICODE_PROP_BASIC_EMOJI2_TABLE: [u8; 183] = [
...
pub const UNICODE_PROP_RGI_EMOJI_MODIFIER_SEQUENCE_TABLE: [u8; 73] = [
...
pub const UNICODE_PROP_RGI_EMOJI_FLAG_SEQUENCE_TABLE: [u8; 128] = [
...
pub const UNICODE_PROP_EMOJI_KEYCAP_SEQUENCE_TABLE: [u8; 4] = [
    0xa2, 0x05, 0x04, 0x89,
];

pub const UNICODE_PROP_ASCII_HEX_DIGIT_TABLE: [u8; 5] = [
    0xaf, 0x89, 0x35, 0x99, 0x85,
];

pub const UNICODE_PROP_BIDI_CONTROL_TABLE: [u8; 10] = [
    0x46, 0x1b, 0x80, 0x59, 0xf0, 0x81, 0x99, 0x84,
    0xb6, 0x83,
];

pub const UNICODE_PROP_DASH_TABLE: [u8; 58] = [
...
pub const UNICODE_PROP_EXTENDER_TABLE: [u8; 111] = [
...
pub const UNICODE_PROP_HEX_DIGIT_TABLE: [u8; 12] = [
    0xaf, 0x89, 0x35, 0x99, 0x85, 0x60, 0xfe, 0xa8,
    0x89, 0x35, 0x99, 0x85,
];

pub const UNICODE_PROP_IDS_UNARY_OPERATOR_TABLE: [u8; 4] = [
    0x60, 0x2f, 0xfd, 0x81,
];

pub const UNICODE_PROP_IDS_BINARY_OPERATOR_TABLE: [u8; 8] = [
    0x60, 0x2f, 0xef, 0x09, 0x89, 0x41, 0xf0, 0x80,
];

pub const UNICODE_PROP_IDS_TRINARY_OPERATOR_TABLE: [u8; 4] = [
    0x60, 0x2f, 0xf1, 0x81,
];

pub const UNICODE_PROP_IDEOGRAPHIC_TABLE: [u8; 72] = [
...
pub const UNICODE_PROP_JOIN_CONTROL_TABLE: [u8; 4] = [
    0x60, 0x20, 0x0b, 0x81,
];

pub const UNICODE_PROP_LOGICAL_ORDER_EXCEPTION_TABLE: [u8; 15] = [
    0x4e, 0x3f, 0x84, 0xfa, 0x84, 0x4a, 0xef, 0x11,
    0x80, 0x60, 0x90, 0xf9, 0x09, 0x00, 0x81,
];

pub const UNICODE_PROP_MODIFIER_COMBINING_MARK_TABLE: [u8; 16] = [
    0x46, 0x53, 0x09, 0x80, 0x40, 0x82, 0x05, 0x02,
    0x81, 0x41, 0xe0, 0x08, 0x12, 0x80, 0x9e, 0x80,
];

pub const UNICODE_PROP_NONCHARACTER_CODE_POINT_TABLE: [u8; 71] = [
...
pub const UNICODE_PROP_PATTERN_SYNTAX_TABLE: [u8; 58] = [
...
pub const UNICODE_PROP_PATTERN_WHITE_SPACE_TABLE: [u8; 11] = [
    0x88, 0x84, 0x91, 0x80, 0xe3, 0x80, 0x5f, 0x87,
    0x81, 0x97, 0x81,
];

pub const UNICODE_PROP_QUOTATION_MARK_TABLE: [u8; 31] = [
...
pub const UNICODE_PROP_RADICAL_TABLE: [u8; 9] = [
    0x60, 0x2e, 0x7f, 0x99, 0x80, 0xd8, 0x8b, 0x40,
    0xd5,
];

pub const UNICODE_PROP_REGIONAL_INDICATOR_TABLE: [u8; 4] = [
    0x61, 0xf1, 0xe5, 0x99,
];

pub const UNICODE_PROP_SENTENCE_TERMINAL_TABLE: [u8; 213] = [
...
pub const UNICODE_PROP_SOFT_DOTTED_TABLE: [u8; 79] = [
...
pub const UNICODE_PROP_TERMINAL_PUNCTUATION_TABLE: [u8; 264] = [
...
pub const UNICODE_PROP_UNIFIED_IDEOGRAPH_TABLE: [u8; 48] = [
...
pub const UNICODE_PROP_EMOJI_TABLE: [u8; 238] = [
...
pub const UNICODE_PROP_EMOJI_COMPONENT_TABLE: [u8; 28] = [
...
pub const UNICODE_PROP_EMOJI_MODIFIER_TABLE: [u8; 4] = [
    0x61, 0xf3, 0xfa, 0x84,
];

pub const UNICODE_PROP_EMOJI_MODIFIER_BASE_TABLE: [u8; 71] = [
    0x60, 0x26, 0x1c, 0x80, 0x40, 0xda, 0x80, 0x8f,
    0x83, 0x61, 0xcc, 0x76, 0x80, 0xbb, 0x11, 0x01,
...
pub const UNICODE_PROP_EMOJI_PRESENTATION_TABLE: [u8; 144] = [
    0x60, 0x23, 0x19, 0x81, 0x40, 0xcc, 0x1a, 0x01,
    0x80, 0x42, 0x08, 0x81, 0x94, 0x81, 0xb1, 0x8b,
    0xaa, 0x80, 0x92, 0x80, 0x8c, 0x07, 0x81, 0x90,
    0x0c, 0x0f, 0x04, 0x80, 0x94, 0x06, 0x08, 0x03,
...
pub const UNICODE_PROP_EXTENDED_PICTOGRAPHIC_TABLE: [u8; 156] = [
    0x40, 0xa8, 0x03, 0x80, 0x5f, 0x8c, 0x80, 0x8b,
    0x80, 0x40, 0xd7, 0x80, 0x95, 0x80, 0xd9, 0x85,
...
pub const UNICODE_PROP_DEFAULT_IGNORABLE_CODE_POINT_TABLE: [u8; 51] = [
...
pub const UNICODE_PROP_TABLE: [&[u8]; 57] = [
...
pub const UNICODE_PROP_LEN_TABLE: [u16; 57] = [
    UNICODE_PROP_HYPHEN_TABLE.len() as u16,
    UNICODE_PROP_OTHER_MATH_TABLE.len() as u16,
    UNICODE_PROP_OTHER_ALPHABETIC_TABLE.len() as u16,
    UNICODE_PROP_OTHER_LOWERCASE_TABLE.len() as u16,
    UNICODE_PROP_OTHER_UPPERCASE_TABLE.len() as u16,
    UNICODE_PROP_OTHER_GRAPHEME_EXTEND_TABLE.len() as u16,
    UNICODE_PROP_OTHER_DEFAULT_IGNORABLE_CODE_POINT_TABLE.len() as u16,
    UNICODE_PROP_OTHER_ID_START_TABLE.len() as u16,
    UNICODE_PROP_OTHER_ID_CONTINUE_TABLE.len() as u16,
    UNICODE_PROP_PREPENDED_CONCATENATION_MARK_TABLE.len() as u16,
    UNICODE_PROP_ID_CONTINUE1_TABLE.len() as u16,
    UNICODE_PROP_XID_START1_TABLE.len() as u16,
    UNICODE_PROP_XID_CONTINUE1_TABLE.len() as u16,
    UNICODE_PROP_CHANGES_WHEN_TITLECASED1_TABLE.len() as u16,
    UNICODE_PROP_CHANGES_WHEN_CASEFOLDED1_TABLE.len() as u16,
    UNICODE_PROP_CHANGES_WHEN_NFKC_CASEFOLDED1_TABLE.len() as u16,
    UNICODE_PROP_BASIC_EMOJI1_TABLE.len() as u16,
    UNICODE_PROP_BASIC_EMOJI2_TABLE.len() as u16,
    UNICODE_PROP_RGI_EMOJI_MODIFIER_SEQUENCE_TABLE.len() as u16,
    UNICODE_PROP_RGI_EMOJI_FLAG_SEQUENCE_TABLE.len() as u16,
    UNICODE_PROP_EMOJI_KEYCAP_SEQUENCE_TABLE.len() as u16,
    UNICODE_PROP_ASCII_HEX_DIGIT_TABLE.len() as u16,
    UNICODE_PROP_BIDI_CONTROL_TABLE.len() as u16,
    UNICODE_PROP_DASH_TABLE.len() as u16,
    UNICODE_PROP_DEPRECATED_TABLE.len() as u16,
    UNICODE_PROP_DIACRITIC_TABLE.len() as u16,
    UNICODE_PROP_EXTENDER_TABLE.len() as u16,
    UNICODE_PROP_HEX_DIGIT_TABLE.len() as u16,
    UNICODE_PROP_IDS_UNARY_OPERATOR_TABLE.len() as u16,
    UNICODE_PROP_IDS_BINARY_OPERATOR_TABLE.len() as u16,
    UNICODE_PROP_IDS_TRINARY_OPERATOR_TABLE.len() as u16,
    UNICODE_PROP_IDEOGRAPHIC_TABLE.len() as u16,
    UNICODE_PROP_JOIN_CONTROL_TABLE.len() as u16,
    UNICODE_PROP_LOGICAL_ORDER_EXCEPTION_TABLE.len() as u16,
    UNICODE_PROP_MODIFIER_COMBINING_MARK_TABLE.len() as u16,
    UNICODE_PROP_NONCHARACTER_CODE_POINT_TABLE.len() as u16,
    UNICODE_PROP_PATTERN_SYNTAX_TABLE.len() as u16,
    UNICODE_PROP_PATTERN_WHITE_SPACE_TABLE.len() as u16,
    UNICODE_PROP_QUOTATION_MARK_TABLE.len() as u16,
    UNICODE_PROP_RADICAL_TABLE.len() as u16,
    UNICODE_PROP_REGIONAL_INDICATOR_TABLE.len() as u16,
    UNICODE_PROP_SENTENCE_TERMINAL_TABLE.len() as u16,
    UNICODE_PROP_SOFT_DOTTED_TABLE.len() as u16,
    UNICODE_PROP_TERMINAL_PUNCTUATION_TABLE.len() as u16,
    UNICODE_PROP_UNIFIED_IDEOGRAPH_TABLE.len() as u16,
    UNICODE_PROP_VARIATION_SELECTOR_TABLE.len() as u16,
    UNICODE_PROP_WHITE_SPACE_TABLE.len() as u16,
    UNICODE_PROP_BIDI_MIRRORED_TABLE.len() as u16,
    UNICODE_PROP_EMOJI_TABLE.len() as u16,
    UNICODE_PROP_EMOJI_COMPONENT_TABLE.len() as u16,
    UNICODE_PROP_EMOJI_MODIFIER_TABLE.len() as u16,
    UNICODE_PROP_EMOJI_MODIFIER_BASE_TABLE.len() as u16,
    UNICODE_PROP_EMOJI_PRESENTATION_TABLE.len() as u16,
    UNICODE_PROP_EXTENDED_PICTOGRAPHIC_TABLE.len() as u16,
    UNICODE_PROP_DEFAULT_IGNORABLE_CODE_POINT_TABLE.len() as u16,
    UNICODE_PROP_ID_START_TABLE.len() as u16,
    UNICODE_PROP_CASE_IGNORABLE_TABLE.len() as u16,
];


pub const UNICODE_RGI_EMOJI_TAG_SEQUENCE: [u8; 18] = [
    0x67, 0x62, 0x65, 0x6e, 0x67, 0x00, 0x67, 0x62,
    0x73, 0x63, 0x74, 0x00, 0x67, 0x62, 0x77, 0x6c,
    0x73, 0x00,
];

pub const UNICODE_RGI_EMOJI_ZWJ_SEQUENCE: [u8; 2320] = [
